...
> **About this project:** This was built as a hands-on experiment in agentic AI. The goal was to see how far an AI assistant ([OpenClaw](https://openclaw.ai), running Claude) could carry an end-to-end data analysis project with only high-level direction from a human. Everything here — the data retrieval, environment setup, notebook structure, analysis, visualizations, and writeup — was generated by OpenClaw with supervision from the project owner. No manual code was written.
